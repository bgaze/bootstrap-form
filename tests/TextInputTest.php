...
class TextInputTest extends TestCase
{
    ...
    {
        $expected = '<div id="field_group" class="form-group"><label for="field">Field</label>'
    ...
    {
        $expected = '<div id="login_group" class="form-group"><label for="login">Your login</label>'
    ...
    {
        $expected = '<div id="login_group" class="form-group">'
    ...
    {
        $expected = '<div id="amount_group" class="form-group"><label for="amount">Amount</label>'
    ...
    {
        $expected = '<div id="secret_group" class="form-group"><label for="secret">Secret</label>'
    ...
    public function test_validation_error_adds_invalid_classes_and_feedback(): void
    {
        ...
        $expected = '<div id="login_group" class="is-invalid form-group"><label for="login">Login</label>'
