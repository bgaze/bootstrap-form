...
class LiteralAttributeTest extends TestCase
{
    ...
    public function test_tilde_survives_into_checkbox_collection_children(): void
    {
        $expected = '<div id="roles_group" class="form-group"><label for="roles">Roles</label><div>'
            . '<div class="form-check"><input data-x="y" id="roles_a" class="form-check-input" name="roles" type="checkbox" value="a"><label for="roles_a" class="form-check-label">A</label></div>'
            . '<div class="form-check"><input data-x="y" id="roles_b" class="form-check-input" name="roles" type="checkbox" value="b"><label for="roles_b" class="form-check-label">B</label></div>'
            . '</div></div>';
