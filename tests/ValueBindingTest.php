...
class ValueBindingTest extends TestCase
{
    ...
    public function test_old_input_repopulates_text(): void
    {
        ...
        $expected = '<div id="login_group" class="form-group"><label for="login">Login</label>'
    ...
    public function test_old_input_repopulates_textarea(): void
    {
        ...
        $expected = '<div id="bio_group" class="form-group"><label for="bio">Bio</label>'
    ...
    public function test_old_input_selects_option(): void
    {
        ...
        $expected = '<div id="color_pick_group" class="form-group"><label for="color_pick">Color pick</label>'
    ...
    public function test_old_input_checks_checkbox(): void
    {
        ...
        $expected = '<div id="accept_group" class="form-group"><div><div class="form-check">'
    ...
    public function test_old_input_checks_checkboxes_collection(): void
    {
        ...
        $expected = '<div id="roles_group" class="form-group"><label for="roles">Roles</label><div>'
            . '<div class="form-check"><input id="roles_admin" class="form-check-input" checked="checked" name="roles" type="checkbox" value="admin"><label for="roles_admin" class="form-check-label">Admin</label></div>'
            . '<div class="form-check"><input id="roles_editor" class="form-check-input" checked="checked" name="roles" type="checkbox" value="editor"><label for="roles_editor" class="form-check-label">Editor</label></div>'
            . '<div class="form-check"><input id="roles_guest" class="form-check-input" name="roles" type="checkbox" value="guest"><label for="roles_guest" class="form-check-label">Guest</label></div>'
            . '</div></div>';
    ...
    {
        $expected = '<div id="c_group" class="form-group"><label for="c">C</label>'
