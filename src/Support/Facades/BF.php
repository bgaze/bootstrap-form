 ...
 * @method static \Illuminate\Contracts\Session\Session getSessionStore() Get session store.
 ...
 * @method static string select(string $name,  $label = null, \ArrayAccess|array $choices = [],  $selected = null, array $options = []) Create a select box field.
 ...
 * @method static string checkboxes(string $name,  $label = null, array $choices = [],  $checked = null, array $options = []) Create a collection of Bootstrap checkboxes.
 * @method static string radio(string $name,  $label = null,  $value = null,  $checked = null, array $options = []) Create a Bootstrap radio input.
 * @method static string radios(string $name,  $label = null, array $choices = [],  $checked = null, array $options = []) Create a collection of Bootstrap radio inputs.
